...
| ST-007 | Triple-blocked dead-end safely backs off | positive | 3x6 closed top corridor | 30 tick 오실레이션 | `collisions=0` | 안전 |
...
| ST-030 | Long oscillation in dead-end | negative | 3x5 dead-end, 500 tick | 결정적 오실레이션 | `no_collisions` | NFR-DET-001 |
| ST-031 | Maze with multiple dead-ends | negative | 7x7 maze | 200 tick | `no_collisions` | UC-003/004 |

총 **31** 케이스 (positive 22, negative 9). NFR-SYS-001 (≥30 / pos·neg) 충족.
...
- [x] **≥30** 케이스, positive 22 / negative 9 균형.
